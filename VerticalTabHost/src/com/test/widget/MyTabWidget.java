...
public class MyTabWidget extends LinearLayout implements OnFocusChangeListener {
    ...
    private void initTabWidget() {
      ...
      /*  try {
        	int par = 0x400;
        	Method method = this.getClass().getSuperclass().getSuperclass().getDeclaredMethod("setBooleanFlag", new Class[]{int.class,boolean.class});
        	method.setAccessible(true);
        	method.invoke(this, par,true);
...
*/
        ...
        if (context.getApplicationInfo().targetSdkVersion <= Build.VERSION_CODES.DONUT) {
            ...
            mBottomLeftStrip = resources.getDrawable(
                    R.drawable.tab_bottom_left_v4);
            mBottomRightStrip = resources.getDrawable(
                    R.drawable.tab_bottom_right_v4); 
        } else {
