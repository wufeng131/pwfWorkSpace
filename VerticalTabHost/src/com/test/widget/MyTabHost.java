...
mTabHost.addTab(TAB_TAG_1, "Hello, world!", "Tab 1");
    ...
    public class TabSpec {
		...
		public TabSpec setIndicator(String label, int id) {
			mIndicatorStrategy = new LabelAndIconIndicatorStrategyFromRes(label, id);
            return this;
		}
    }
     ...
     *
     */
    private class LabelAndIconIndicatorStrategyFromRes implements IndicatorStrategy {

        private final CharSequence mLabel;
        private final int mIcon;

        private LabelAndIconIndicatorStrategyFromRes(CharSequence label, int icon) {
            mLabel = label;
            mIcon = icon;
        }
